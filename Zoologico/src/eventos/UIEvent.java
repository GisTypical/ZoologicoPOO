...
public class UIEvent implements ActionListener {
    ...
    public UIEvent(JTextField nField, JTextField eField, JTextField aField, JTextField tField, JTextField cField) {
